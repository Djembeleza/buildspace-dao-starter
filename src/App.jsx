...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0x6823422b667091739FEEc2D7422C6B350522b620");
  const token = useToken("0x95a6258DcCB83D73BEbDf414260FDBE1781B0fc4");
  const vote = useVote("0x5F876f11A48d021D12313363a3AE99FE9b9c1079");
